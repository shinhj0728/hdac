...
//
void	Rc4Initialise(Rc4Context *Context, void *Key, uint32_t KeySize, uint32_t DropN)
{
    uint32_t        i;
    uint32_t        j;
    uint32_t        n;
...
// This is used for encrypting and decrypting data. InBuffer and OutBuffer can point 
// to the same location for inplace encrypting/decrypting
//
void	Rc4Xor(Rc4Context *Context, void *InBuffer, void *OutBuffer, uint32_t Size)
{
    uint32_t    n;
