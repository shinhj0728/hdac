...
// Sha1Context - This must be initialised using Sha1Initialised. 
...
//
//  Adds data to the SHA1 context. This will process the data and update 
// the internal state of the context. Keep on calling this function until 
// all the data has been added. Then call Sha1Finalise to calculate the hash.
//
void	Sha1Update(Sha1Context *Context, const void *Buffer, const uint32_t BufferSize);

//
// Performs the final calculation of the hash and returns the digest 
// (20 byte buffer containing 160bit hash). After calling this, 
// Sha1Initialised must be used to reuse the context.
//
